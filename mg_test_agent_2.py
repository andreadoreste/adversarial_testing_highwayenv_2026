...
retrained_ego = "out/MergeEnvMA/DQNAgent/run_20260731-181804_11471/checkpoint-final.tar"

adv_list = [
    "out/MergeEnvMA/DQNAgent/run_20260714-141004_954738/checkpoint-final.tar" #second best adv
]

repetitions = 10

file_name = 'mg_test_retrained_ego_second_best_adv' + datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + '.csv'
